...
<body>
	<div class="container-fluid">
		<div onclick="location.href = './soap/facebook';" class="block"
			style="background-color: #4867AA;">
			<i style="color: white;" class="fa-5x fab fa-facebook"></i>
		</div>
		<div onclick="location.href = './soap/google';" class="block"
			style="background-color: white">
			<i style="color: orangered;" class="fa-5x fab fa-google"></i>

		</div>
		<div onclick="location.href = './soap/github';" class="block"
			style="background-color: whitesmoke;">
			<i class="fa-5x fab fa-github"></i>

		</div>
		<div onclick="location.href = './soap/linkedin';" class="block"

...
exports.getRuleConfig = exports.decodeSonarRuntimeIssue = exports.analyze = void 0;
/*
...
linter.defineRule(NO_UNUSED_EXPRESSIONS, no_unused_expressions_decorator_1.decorateChaiFriendly(eslint_plugin_chai_friendly_1.rules[NO_UNUSED_EXPRESSIONS]));
try {
    ...
    if (noUnusedExpressionsRule) {
        linter.defineRule(NO_UNUSED_EXPRESSIONS, no_unused_expressions_decorator_1.decorateTypescriptEslint(noUnusedExpressionsRule));
    }
}
catch (_a) {

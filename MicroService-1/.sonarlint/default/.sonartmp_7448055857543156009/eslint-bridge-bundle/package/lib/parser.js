...
exports.parseExceptionCodeOf = exports.ParseExceptionCode = exports.parse = exports.parseVueSourceFile = exports.unloadTypeScriptEslint = exports.checkTypeScriptVersionCompatibility = exports.resetReportedNewerTypeScriptVersion = exports.parseTypeScriptSourceFile = exports.parseJavaScriptSourceFile = exports.PARSER_CONFIG_SCRIPT = exports.PARSER_CONFIG_MODULE = void 0;
/*
...
function parseTypeScriptSourceFile(fileContent, filePath, tsConfigs) {
    try {
        ...
        const result = tsParser.parseForESLint(fileContent, Object.assign(Object.assign({}, exports.PARSER_CONFIG_MODULE), { filePath, project: tsConfigs, loggerFn: console.log }));
...
function parseVueSourceFile(fileContent) {
    ...
    const vueModuleConfig = Object.assign(Object.assign({}, exports.PARSER_CONFIG_MODULE), { parser: 'babel-eslint' });
